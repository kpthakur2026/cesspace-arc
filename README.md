...
| :-------- | :------------------------------------- | :-------------------------------------------------------------------------------- | :------------------------------------- |
| **RC-00** | **Architecture & Security Foundation** | Trust boundaries, threat models, invariants, tool taxonomy, ADRs.                 | **Proposed Baseline (Pending Review)** |
| **RC-01** | **Read-Only MCP Core**                 | Minimal Security Kernel, 9 read-only tools, canonical jailing, negative controls. | Upcoming                               |
